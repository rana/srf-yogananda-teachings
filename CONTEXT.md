...
- **Documentation is a permanent artifact.** Twelve documents (CLAUDE.md, PRINCIPLES.md, CONTEXT.md, DESIGN.md + 2 arc files, DECISIONS.md index + 3 body files, PROPOSALS.md, ROADMAP.md) are as important as the code. New maintainers in year 7 should understand every decision.
