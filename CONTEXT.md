...
**What exists:** Comprehensive design documentation — CONTEXT.md (this file), DESIGN.md (architecture + 48 design sections DES-001 through DES-048), DECISIONS.md (98 ADRs, numbered 001–098, organized into 11 topical groups), ROADMAP.md (18 phases, 0–17). No code yet.
...
- [ ] `/guide` alignment with SRF reading recommendations: SRF may already publish recommended reading orders or topical reading guides through its own channels. The `/guide` page (DES-047) should align with, not compete with, SRF's pastoral voice. Does SRF have existing reading recommendation materials that should inform the `/guide` page content? Should `/guide` be reviewed by the same theological reviewers as editorial reading threads? (Relates to DES-047, DES-026)
