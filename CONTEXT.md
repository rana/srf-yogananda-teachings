...
**What exists:** Comprehensive design documentation — CONTEXT.md (this file), DESIGN.md (architecture), DECISIONS.md (121 ADRs), ROADMAP.md (17 phases, 0–16). No code yet.
