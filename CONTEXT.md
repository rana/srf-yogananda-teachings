...
**What exists:** Comprehensive design documentation — CONTEXT.md (this file), DESIGN.md (architecture + 49 design sections DES-001 through DES-049), DECISIONS.md (103 ADRs, numbered 001–103, organized into 11 topical groups), ROADMAP.md (15 phases, 0–14). No code yet.
...
- [ ] Can SRF provide recordings of Yogananda's own voice for an IVR/audio pilot during the Hindi/Bengali launch (Phase 10), rather than deferring all voice access to Phase 14? (Relates to ADR-026)
...
| **Portal coordinator** | Cross-queue editorial health, content pipeline status, VLD activity, calendar planning, feature request triage | Regular (weekly minimum) | Phase 4 |
