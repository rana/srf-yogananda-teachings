<!-- elmer:archive
  id: clarify-copyright-stance-srf-makes-it-feel-available-to-all
  topic: Clarify copyright stance. SRF makes it feel available to all, including search engines and AI models for reference and citation. SRF still reserves all copyrights. Perhaps have page and endpoint.
  archetype: explore-act
  model: opus
  status: approved
  archived: 2026-02-24 03:30 UTC
-->
