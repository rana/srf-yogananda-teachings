...
| Schema change | DESIGN-phase0.md § DES-004 | Amend data model section |
...
5. ROADMAP.md — phase and deliverable changes
6. CONTEXT.md — open questions and state changes
7. PROPOSALS.md — update PRO-NNN status to `Adopted → [ADR/DES/Phase refs]`
...
- **ADR maturity markers.** New ADRs created from proposals should carry appropriate maturity status (Active for current-phase work, Provisional for future-phase work). See ADR-098 for the classification.
